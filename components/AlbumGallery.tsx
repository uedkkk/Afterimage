      ...
      <div className="columns-1 sm:columns-2 lg:columns-3 gap-5">
        {photos.map((photo, index) => (
          <button
            ...
            className="break-inside-avoid mb-5 relative overflow-hidden cursor-pointer group block w-full"
          >
            <Image
              src={photo.filePath}
              ...
              className="w-full block transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.03]"
            />
